...
export{PointType,PointTypeDescription, CITY_NAME, CITY_DESCRIPTION, PICTURE_DESCRIPTION, OFFER_COUNT,OFFER_TITLE, POINT_COUNT, OFFER_DESCRIPTION_COUNT, DATA_TIME, DATA_NUMBER_MONTH, DATA_HOUR_MINUTE, DATE_GAP, PRICE, PICTURE_COUNT};
